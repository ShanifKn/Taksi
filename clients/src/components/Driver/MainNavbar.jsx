          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Upcomming Trips</span>
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              <a
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Trip History</span>
              </a>
            </li>
            <li>
              <a
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">My Earnings</span>
              </a>
            </li>
            <li>
              <Link
